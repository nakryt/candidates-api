...
exports.AddEmailPhoneConstraints1737568200000 = void 0;
class AddEmailPhoneConstraints1737568200000 {
    constructor() {
        this.name = "AddEmailPhoneConstraints1737568200000";
    }
    ...
    `);
        if (duplicateEmails?.length > 0) {
            throw new Error(`Found duplicate emails: ${duplicateEmails.map((r) => r.email).join(", ")}. ` +
                `Please clean up duplicates before running this migration.`);
        }
        if (duplicatePhones?.length > 0) {
            throw new Error(`Found duplicate phones: ${duplicatePhones.map((r) => r.phone).join(", ")}. ` +
                `Please clean up duplicates before running this migration.`);
        }
...
exports.AddEmailPhoneConstraints1737568200000 = AddEmailPhoneConstraints1737568200000;
